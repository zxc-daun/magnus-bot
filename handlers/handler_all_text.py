...
class HandlerAllText(Handler):
    ...
    def pressed_btn_back(self, message):
        ...
        """
        self.bot.send_message(message.chat.id, "You came back",
    ...
    def handle(self):
        ...
        def handle(message):
            ...
            if message.text == config.KEYBOARD['DEVICES']:
                self.pressed_btn_product(message, 'DEVICES')

            if message.text == config.KEYBOARD['PC']:
                self.pressed_btn_product(message, 'PC')
